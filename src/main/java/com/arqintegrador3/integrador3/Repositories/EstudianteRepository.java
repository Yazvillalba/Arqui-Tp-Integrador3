...
public interface EstudianteRepository extends JpaRepository<Estudiante, Integer> {
    ...
    @Query(value = "SELECT NEW com.arqintegrador3.integrador3.DTO.EstudianteDTO(e.dni, e.nombre,e.apellido,e.edad,e.genero,e.ciudad,e.nroLibreta) FROM Estudiante e WHERE e.nroLibreta = :nroLibreta")
    EstudianteDTO findEstudianteByNroLibreta(@Param("nroLibreta") int nroLibreta);
    ...
    List<EstudianteDTO> findEstudiantesByCarrerasAndCiudad(@Param("nombreCarrera") String nombreCarrera, @Param("ciudad") String ciudad);
}
