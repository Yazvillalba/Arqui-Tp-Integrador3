...
public interface MatriculaRepository extends JpaRepository<Matricula, Integer> {
    @Query(value = "SELECT NEW com.arqintegrador3.integrador3.DTO.MatriculaDTO(m.anioInscripcion, m.graduacion, m.antiguedad, m.estudiante, m.carrera) FROM Matricula m")
